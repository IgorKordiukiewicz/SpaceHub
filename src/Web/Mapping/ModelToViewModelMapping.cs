...
public static class ModelToViewModelMapping
{
    ...
    public static LaunchDetailsCardViewModel ToLaunchDetailsCardViewModel(this Launch launch)
    {
        return new()
        {
            ...
            DateJsMilliseconds = launch.Date is not null ? Helpers.DateToJsMilliseconds(launch.Date.Value) : 0,
    ...
    public static EventDetailsCardViewModel ToEventDetailsCardViewModel(this Event event_)
    {
        return new()
        {
            ...
            Date = Helpers.DateToString(event_.Date) ?? "-",
            DateJsMilliseconds = event_.Date is not null ? Helpers.DateToJsMilliseconds(event_.Date.Value) : 0,
