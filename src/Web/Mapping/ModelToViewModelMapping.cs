    ...
    public static class ModelToViewModelMapping
    {
        ...
        public static RocketCardViewModel ToRocketCardViewModel(this Rocket rocket)
        {
            ...
            return new()
            {
                ...
                MaxStages = Utils.ValueToStringWithSymbol(rocket.Details.MaxStage, ""),
                LaunchCost = Utils.ValueToStringWithSymbol(rocket.Details.LaunchCost, "$"),
                LiftoffMass = Utils.ValueToStringWithSymbol(rocket.Details.LaunchMass, "T"),
                LiftoffThrust = Utils.ValueToStringWithSymbol(rocket.Details.ThrustAtLiftoff, "kN"),
